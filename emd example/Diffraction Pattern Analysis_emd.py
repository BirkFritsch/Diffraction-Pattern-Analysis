...
df = main(show = True,                    #True: Processing steps are shown, slows algorithm down
          ...
          re_pattern='emd$',              #A regular expression pattern can be provided to select different file types or prestructured files by their name. Loading is performed via hyperspy. Particularly, it is tested for the following formats: emd, tiff, hspy
